...
void DataVisualizer::visualizeNormalsCloud(visualization::PCLVisualizer::Ptr viewer, int viewport)
{
  ...
  if(data_handler_->point_clouds_updated_)
  {
    ...
    viewer->addPointCloudNormals<PointXYZ,Normal>(data_handler_->smoothed_cloud_, data_handler_->cloud_normals_,
...
void DataVisualizer::DataVisualizer::visualizePlaneCloud(visualization::PCLVisualizer::Ptr viewer, int viewport)
{
